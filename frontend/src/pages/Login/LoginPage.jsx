                ...
                <form onSubmit={signUpForm.handleSubmit(onRegisterSubmit, (errors) => {
                  ...
                  {selectedRole.requiresApproval && (
                    <div style={{
                      ...
                      <MdInfo style={{ color: "#F59E0B", fontSize: 16, flexShrink: 0, marginTop: 1 }} />
                      <p style={{ margin: 0, fontSize: 11, color: "rgba(255,255,255,0.5)", lineHeight: 1.5 }}>
                        Manager requests are reviewed by Master Admin (<code style={{ color: "#fff" }}>pranavkaushikyr@gmail.com</code>) before account activation.
                      </p>
                    </div>
                  )}
