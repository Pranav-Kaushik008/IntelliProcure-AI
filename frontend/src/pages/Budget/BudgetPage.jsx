                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setEditingBudget({ ...editingBudget, allocated_amount: Number(e.target.value) })}
                      required
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setEditingBudget({ ...editingBudget, spent_amount: Number(e.target.value) })}
                      required
                    />
                  </div>
                </div>
