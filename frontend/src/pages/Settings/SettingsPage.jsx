        ...
        <div className="card">
          ...
          <div style={{ overflowX: "auto" }}>
            <table className="data-table">
              ...
              <tbody>
                {[
                  { time: "2024-08-05 12:10:04", user: "Alex Thompson (CPO)", action: "PO_ISSUED", entity: "PO-2024-00891", ip: "192.168.1.45", status: "Success" },
                  { time: "2024-08-05 11:42:19", user: "Sarah Johnson (Buyer)", action: "PR_SUBMITTED", entity: "PR-2024-10042", ip: "192.168.1.88", status: "Success" },
                  { time: "2024-08-05 10:15:00", user: "System (AI Service)", action: "INVOICE_FRAUD_AUDIT", entity: "INV-2024-0342", ip: "127.0.0.1", status: "Flagged" },
                  { time: "2024-08-05 09:30:12", user: "Michael Chen (Manager)", action: "PR_APPROVED", entity: "PR-2024-10040", ip: "192.168.1.12", status: "Success" }
                ].map((row, idx) => (
                  <tr key={idx}>
                    <td style={{ fontSize: 12 }}>{row.time}</td>
