...
async def create_purchase_request(
    ...
    AuditService.log_event(
        ...
        changes={"title": pr.title, "amount": pr.estimated_amount, "status": str(pr.status)}
    )
...
async def submit_pr(
    ...
    AuditService.log_event(
        ...
        entity_id=pr.pr_number,
        user_id=current_user.id,
        changes={"title": pr.title, "amount": pr.estimated_amount, "status": "submitted"}
    )
...
async def approve_pr(
    ...
    AuditService.log_event(
        ...
        entity_id=pr.pr_number,
        user_id=current_user.id,
        changes={"title": pr.title, "amount": pr.estimated_amount, "approver": current_user.email, "notes": notes}
    )
...
async def reject_pr(
    ...
    AuditService.log_event(
        ...
        entity_id=pr.pr_number,
        user_id=current_user.id,
        changes={"title": pr.title, "amount": pr.estimated_amount, "approver": current_user.email, "reason": reason}
    )
